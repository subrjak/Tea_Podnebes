                    ...
                    <div className="features-grid">
                        <div className="feature">
                            <div className="feature-icon"><svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="50" cy="50" r="48" stroke="url(#paint0_linear_52_80)" stroke-width="4" />
                                ...
                                <defs>
                                    <linearGradient id="paint0_linear_52_80" x1="100" y1="50" x2="0" y2="50" gradientUnits="userSpaceOnUse">
                                        <stop stop-color="#AE8842" />
                                        <stop offset="0.5" stop-color="#8B8A7B" />
                                        <stop offset="1" stop-color="#AE8842" />
                                    </linearGradient>
                                </defs>
                            </svg>
                            </div>
                        ...
                        <div className="feature">
                            <div className="feature-icon"><svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="50" cy="50" r="48" stroke="url(#paint0_linear_363_61)" stroke-width="4" />
