...
const teaTypes = [
  {
    title: 'Красный чай',
    description: 'Мягкий, согревающий вкус для спокойного вечера.',
    image: '/img/red_tea.jpg',
  },
  {
    title: 'Белый чай',
    description: 'Нежный настой с легким ароматом цветов и меда.',
    image: '/img/white_tea.jpg',
  },
  {
    title: 'Улуны',
    description: 'Баланс свежести, сливочности и выразительного аромата.',
    image: '/img/oolong.jpg',
  },
  {
    title: 'Пуэры',
    description: 'Глубокий плотный чай для неторопливого ритуала.',
    image: '/img/puer.jpg',
  },
  {
    title: 'Зеленый чай',
    description: 'Свежий, травянистый вкус для ясного начала дня.',
...
const features = [
  {
    ...
    title: 'Натуральный чай без добавок',
    description: 'Отборные листья с чайных кустов и деревьев.',
  },
  {
    icon: (
      <svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    title: 'Поставки напрямую из Китая',
    description: 'Работаем с чайными мастерами и проверенными поставщиками.',
  },
  {
    icon: (
      <svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    title: 'Быстрая доставка и самовывоз',
    description: 'Доставка по городу и удобные точки самовывоза.',
  },
  {
    icon: (
      <svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    title: 'Чай как ритуал',
    description: 'Помогаем выбрать вкус под настроение, сезон и момент.',
  },
];
    ...
    <div className="home-page">
      <section className="hero">
        <div className="hero-content">
          ...
          <p className="hero-subtitle">
            Пуэры, улуны и другие чаи напрямую от китайских поставщиков.
          </p>
      ...
      <section className="tea-types">
        ...
        <div className="tea-grid">
          {teaTypes.map((tea) => (
            <div className="home-tea-card" key={tea.title}>
              <img src={tea.image} alt={tea.title} className="home-tea-card__image" />
              <h3>{tea.title}</h3>
              <p>{tea.description}</p>
            </div>
          ))}
