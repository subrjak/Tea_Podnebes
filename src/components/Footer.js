        ...
        <div className="footer-content">
          <div className="footer-column">
            ...
            <ul>
              ...
              <li><a href="#">О чайной церемонии</a></li>
            </ul>
          </div>
          <div className="footer-column">
            <h4>Помощь</h4>
            ...
            <div className="social">
              ...
              <div className="social-links">
                <a href="#"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <defs>
                    <linearGradient id="paint0_linear_50_69" x1="800" y1="0" x2="800" y2="1600" gradientUnits="userSpaceOnUse">
                  ...
                  @tea_podnebes</a>
                <a href="#"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12.25 0H3.75C1.67893 0 0 1.67893 0 3.75V12.25C0 14.3211 1.67893 16 3.75 16H12.25C14.3211 16 16 14.3211 16 12.25V3.75C16 1.67893 14.3211 0 12.25 0Z" fill="url(#paint0_radial_50_75)" />
                  <path d="M12.25 0H3.75C1.67893 0 0 1.67893 0 3.75V12.25C0 14.3211 1.67893 16 3.75 16H12.25C14.3211 16 16 14.3211 16 12.25V3.75C16 1.67893 14.3211 0 12.25 0Z" fill="url(#paint1_radial_50_75)" />
                  ...
                  <defs>
                    <radialGradient id="paint0_radial_50_75" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(4.25 17.2323) rotate(-90) scale(15.8572 14.7484)">
                      <stop stop-color="#FFDD55" />
                      <stop offset="0.1" stop-color="#FFDD55" />
                      <stop offset="0.5" stop-color="#FF543E" />
                      <stop offset="1" stop-color="#C837AB" />
                    </radialGradient>
                    <radialGradient id="paint1_radial_50_75" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(-2.68006 1.15256) rotate(78.681) scale(7.08825 29.218)">
